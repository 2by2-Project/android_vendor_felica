...
# HIDL
DEVICE_MANIFEST_FILE += $(FELICA_PATH)/vintf/manifest.xml
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE += $(FELICA_PATH)/vintf/device_framework_matrix.xml
